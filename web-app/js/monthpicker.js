...
test('qUnit Status', function () {
    ok(true, 'qUnit is installed and working.');
});

test('jQuery Status', function () {
...
test('MonthPicker Status', function () {
...
test('Digital Bush Status', function () {
...
test('HTML 5 Month Input Type', function(){
    var _picker = $('#Html5Month').MonthPicker({
        ShowIcon: false
    });

    ok(_picker.length === 1, "#Html5Month initialized.");
});
...
test('Icon Option Tests', function () {
    ...
    equal($('#MonthPicker_Button_IconDemo').length, 0, '#IconDemo icon removed after init.');
